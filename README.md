...
===============
维护人：**二哥** 
代码同步官方 (jeecgboot)->dubbo版本,会慢慢进行优化，有兴趣的朋友可以一起来优化！！相关教程，稍后会在博客中持续更新！！后续会升级为springcloud体系，欢迎持续关注！
...
| 版本           | 组件    | 说明                         |
|---------- |-------------------------------------------------------|------------------|
| 1.0.0     | dubbo 2.7.5 zookeeper 3.4+ redis 5.0.7 |    |
| 2.0.0     | SpringCloud 体系 |    |
